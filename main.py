...
GEMINI_KEY        = os.environ.get("GEMINI_API_KEY", "AIzaSyAAI-jmRluk01VlIL79IzQGWEBHtvDs970")
...
async def call_gemini_text(system: str, user: str, max_tokens: int = 1200) -> str:
